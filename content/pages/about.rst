...
| **Email**           |  |jk_email|         |                     |
+---------------------+---------------------+                     +
| **GitHub**          |  |jk_github|_       | Me at the BDI       |
+---------------------+---------------------+                     +
| **Orcid**           |  |jk_orcid|_        |                     |
+---------------------+---------------------+                     +
...
- I contribute to the `sgkit-dev <https://github.com/sgkit-dev>`_
  GitHub organisation, including leading work on the `VCF Zarr paper
  <https://doi.org/10.1093/gigascience/giaf049>`_ and associated
  `bio2zarr <https://sgkit-dev.github.io/bio2zarr/intro.html>`_
  and `vcztools <https://github.com/sgkit-dev/vcztools>`_ utilities.
...
- I co-organised Probabilistic Modelling in Genomics 2022 conference.
...
2005-2008
    Senior Software Architect, MPSTOR
...
See my `ORCID profile <https://orcid.org/0000-0002-7894-5253>`__ for an up-to-date list of my publications
